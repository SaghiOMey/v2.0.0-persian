    ...
    <>
      ...
      <div className="relative">
        ...
        <div className="absolute grid justify-items-center top-8 md:top-28 w-full text-white">
          ...
          <span className="text-sm md:text-xl font-sans font-bold">Last Updated: September 6, 2023</span>
        </div>
        <div className="absolute text-center -top-12 md:top-16 lg:top-2/4 mt-32 w-full min-h-max bg-black">
          <div className="lg:mb-56 mt-12 lg:ml-20 leading-8 text-gray-200">
            ...
            These terms and conditions were created by <Link className="text-xl md:text-2xl font-sans font-bold text-white" href="https://www.linkedin.com/in/mohammadreza-khorrami-238302215/">Milad</Link>.<br/><br/><br/>
            ...
            <span className="text-xl md:text-2xl font-sans font-bold text-white">(14) </span>
            Whole of guests must agreed to <a href="../assests/SM(Policy).pdf" className="text-blue-900" download>SaghiOMey Policy</a>.<br/><br/><br/>
