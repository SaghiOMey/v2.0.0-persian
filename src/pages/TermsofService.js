      ...
      <div className="relative">
        ...
        <div className="absolute text-center -top-12 md:top-16 lg:top-2/4 mt-32 w-full min-h-max bg-black">
          <div className="lg:mb-56 mt-12 lg:ml-20 leading-8 text-gray-200">
            ...
            <span className="text-xl md:text-2xl font-sans font-bold text-white">(13) </span>
            Whole of videos from Saghi O Mey(SM) put on section video in NFT and whole of sales goes to charity So, these videos put on section video in NFT from side SaghiOMey(SM) It means that the audios are not misused, but it means supporting the charity.<br/><br/><br/>
