    ...
    <>
      ...
      <div className="relative">
        ...
        <div className="absolute grid justify-items-center top-8 md:top-28 w-full text-white">
          ...
          <span className="text-sm md:text-xl font-sans font-bold">Last Updated: June 24, 2023</span>
        </div>
        <div className="absolute text-center -top-12 md:top-16 lg:top-2/4 mt-32 w-full min-h-max bg-black">
          <div className="lg:mb-56 mt-12 lg:ml-20 leading-8 text-gray-200">
            ...
            We care about data privacy and security. Please review our Privacy Policy <a href="#" className="text-blue-900">CLICK HERE</a> By using the Site, you agree to be bound by our Privacy Policy, which is incorporated into these Terms and Conditions. Please be advised the Site is hosted in the United States.<br/><br/><br/>
