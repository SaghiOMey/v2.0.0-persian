                                ...
                                <div class="sm:flex sm:items-start">
                                  ...
                                  <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                    ...
                                    <div class="mt-2">
                                      ...
                                      <p class="text-sm font-semibold text-gray-600">2. You should state your full name, as well as your age (under 18 will not be interviewed), also all the episodes will be recorded by Skype or riverside app and will be video recording.</p>
                                      ...
                                      <p class="text-sm font-semibold text-gray-600">6. You have to choose your best image of yourself for cover episode then upload to site, it can help you separate your episode from others, also your cover & audio & video will put on NFT from side SaghiOMey(please formal image).</p>
                                      ...
                                      <p class="text-sm font-semibold text-gray-600">8. All of episodes will be published by SaghiOMey(SM) team, so would better don't request your episode anytime after record.</p>
