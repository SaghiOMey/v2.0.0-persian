          ...
          <div className="mt-16 -ml-20 h-72 lg:h-auto md:h-44 md:m-0 md:flex md:flex-1 md:items-start md:justify-center bg-black">
            <div className="font-mono font-bold ml-6 text-xs lg:text-xs xl:text-lg text-gray-100">
              ...
              <div className="font-mono flex font-bold lg:ml-56 lg:text-lg text-gray-100">
                ...
                <Link
                  href="/NFT"
                  className="flex text-yellow-500 hover:text-gray-100"
                >
              ...
              <p className="font-mono flex font-bold lg:ml-56 lg:text-lg text-gray-100">
                ...
                <a
                  className="text-yellow-500 -mt-1 ml-2 md:ml-8 lg:ml-8 hover:text-white fill-current"
                  href="https://open.spotify.com/show/6ObUzf2m0OtJNyVvNvwIVp"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" id="spotify"><path d="M20 6a14 14 0 1 0 14 14A14 14 0 0 0 20 6Zm6.42 20.19a.87.87 0 0 1-1.2.29c-3.29-2-7.42-2.46-12.3-1.35a.86.86 0 0 1-1-.65.87.87 0 0 1 .65-1.05c5.34-1.22 9.91-.69 13.6 1.56a.88.88 0 0 1 .25 1.2Zm1.71-3.81a1.09 1.09 0 0 1-1.5.36 18.39 18.39 0 0 0-13.95-1.63 1.09 1.09 0 0 1-.63-2.11 20.4 20.4 0 0 1 15.72 1.86 1.08 1.08 0 0 1 .36 1.52Zm.15-4c-4.51-2.68-12-2.93-16.26-1.62a1.31 1.31 0 1 1-.76-2.5c4.94-1.51 13.16-1.21 18.36 1.87a1.31 1.31 0 1 1-1.34 2.25Z"></path></svg>
                </a>
              </p>
